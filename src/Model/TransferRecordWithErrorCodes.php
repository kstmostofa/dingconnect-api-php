...
class TransferRecordWithErrorCodes implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'transfer_record' => '\Kstmostofa\DingConnect\Model\TransferRecord',
        'result_code' => 'int',
     ...
     *
     * @return \Kstmostofa\DingConnect\Model\TransferRecord
     */
     ...
     *
     * @param \Kstmostofa\DingConnect\Model\TransferRecord $transfer_record The transfer record that was created as a result of a SendTransfer
     *
     * @return $this
     */
     ...
     * Sets error_codes
     *
     * @param \Kstmostofa\DingConnect\Model\Error[] $error_codes Any error codes that were returned as part of the SendTransfer or in the case of a Batch `ProcessingMode`              that may have occurred later after the batch was submitted to the Provider.
     *
     * @return $this
     */
